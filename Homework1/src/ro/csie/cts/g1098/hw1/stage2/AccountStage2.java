package ro.csie.cts.g1098.hw1.stage2;

public class AccountStage2 {
	...
	public static double calculate(AccountStage2[] accounts)
	{
		double totalFee=0.0;
		AccountStage2 account;
	...
	public AccountStage2(double value, double rate, AccountType account_Type) throws Exception {
		if(value<0)
			throw new Exception();
		else
		{
